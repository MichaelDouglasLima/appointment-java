...
INSERT INTO TBL_APPOINTMENT (DATE, START_TIME, END_TIME, STATUS, COMMENTS, CLIENT_ID, PROFESSIONAL_ID, AREA_ID, APPOINTMENT_TYPE_ID) 
    VALUES ( '2028-04-03 00:00:00-03', '08:00:00-03', '08:30:00-03', 'OPEN', 'Parcelar em 3x', 3, 6, 1, 1);

INSERT INTO TBL_APPOINTMENT (DATE, START_TIME, END_TIME, STATUS, COMMENTS, CLIENT_ID, PROFESSIONAL_ID, AREA_ID, APPOINTMENT_TYPE_ID) 
    VALUES ( '2028-04-03 00:00:00-03', '08:30:00-03', '09:00:00-03', 'OPEN', 'Parcelar em 3x', 3, 6, 1, 1);

INSERT INTO TBL_APPOINTMENT (DATE, START_TIME, END_TIME, STATUS, COMMENTS, CLIENT_ID, PROFESSIONAL_ID, AREA_ID, APPOINTMENT_TYPE_ID) 
    VALUES ( '2028-04-03 00:00:00-03', '09:00:00-03', '09:30:00-03', 'OPEN', 'Parcelar em 3x', 3, 6, 1, 1);

INSERT INTO TBL_APPOINTMENT (DATE, START_TIME, END_TIME, STATUS, COMMENTS, CLIENT_ID, PROFESSIONAL_ID, AREA_ID, APPOINTMENT_TYPE_ID) 
    VALUES ( '2028-04-03 00:00:00-03', '09:30:00-03', '10:00:00-03', 'OPEN', '', 4, 6, 1, 2);

INSERT INTO TBL_APPOINTMENT (DATE, START_TIME, END_TIME, STATUS, COMMENTS, CLIENT_ID, PROFESSIONAL_ID, AREA_ID, APPOINTMENT_TYPE_ID) 
    VALUES ( '2028-04-10 00:00:00-03', '09:30:00-03', '10:00:00-03', 'OPEN', 'Ligar para confirmar', 5, 6, 3, 3);